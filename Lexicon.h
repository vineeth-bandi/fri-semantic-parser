...
public:
	...
	std::vector<> get_semantic_forms_for_surface_form(std::vector<> surface_form);
	...
	SemanticNode* read_semantic_form_from_str(std::vector<> s, int category, SemanticNode *parent, std::vector<std::string> scoped_lambdas, bool allow_expanding_ont)
	// surface forms type
